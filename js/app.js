...
const api = "your-api-key"; //get from https://newsapi.org/
let page = 1;
if (cpage === null) {} else {
    ...
    <p>No news to show here</p>
        ...
        for (let newsID = 0; newsID < newsDict.articles.length; newsID++) {
            ...
            if (realNews === null) {} else {
                realNews.innerHTML += `            <div id="${newsID}" class="mx-auto  my-3 bg-white shadow-xl shadow-black-700/50 min-h-full w-72 relative ">
